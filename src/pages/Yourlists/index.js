...
const YourlistsPage = () => {
  ...
  return (
    <>
      <Stack className="bg-white_A700 font-sfprodisplay lg:h-[565px] xl:h-[646px] 2xl:h-[726px] 3xl:h-[871px] mx-[auto] w-[100%]">
        <Column className="absolute items-center left-[24%] top-[4%] w-[39%]">
          ...
          <Column className="lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[100%]">
            <Row className="w-[36%]">
              <Text
                className="common-pointer font-normal not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-gray_600 w-[auto]"
              ...
              <Column className="lg:ml-[19px] xl:ml-[22px] 2xl:ml-[25px] 3xl:ml-[30px] w-[42%]">
        ...
        <Row className="absolute inset-y-[0] left-[11%] right-[12%] w-[77%]">
          <Row className="items-center justify-evenly w-[7%]">
            <Column className="bg-white_A700 items-center w-[100%]">
              ...
              <Img
                src="images/img_unsplashhskble_3.png"
          ...
          <List
            className="gap-[0] min-h-[auto] 2xl:ml-[111px] 3xl:ml-[134px] lg:ml-[86px] xl:ml-[99px] lg:mt-[120px] xl:mt-[137px] 2xl:mt-[154px] 3xl:mt-[185px] w-[50%]"
          ...
          >
            ...
            <Column className="items-center xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[9px] w-[100%]">
              <Row className="items-center justify-between w-[100%]">
                <Column className="w-[72%]">
                  ...
                  <Text className="font-charter font-normal lg:leading-[14px] xl:leading-[16px] 2xl:leading-[18px] 3xl:leading-[21px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-gray_600 w-[100%]">
                    I like Figma, In this article I will go over the different
                    methods of adding animations in Figma, from the most simple
                    to the complex.
                  </Text>
                  <Column className="font-sfprodisplay items-center lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[100%]">
                    <Row className="items-center justify-between w-[100%]">
            ...
            <Column className="items-center xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[9px] w-[100%]">
              <Row className="justify-between w-[100%]">
                <Column className="w-[72%]">
                  <Text className="font-bold font-sfprodisplay xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-gray_900 w-[auto]">
                    UI Interactions of the week #296
                  </Text>
                  <Text className="font-charter font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-gray_600 w-[auto]">
                    UI Interactions of the week #296
                  </Text>
            ...
            <Column className="items-center xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] lg:my-[9px] w-[100%]">
              <Row className="items-center justify-between w-[100%]">
                <Column className="w-[72%]">
                  ...
                  <Text className="font-charter font-normal lg:leading-[14px] xl:leading-[16px] 2xl:leading-[18px] 3xl:leading-[21px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-gray_600 w-[100%]">
                    As a UX designer, you have three fundamental disadvantages
                    when it comes to analyzing motion for usability.
                  </Text>
                  <Column className="font-sfprodisplay items-center lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[100%]">
                    <Row className="items-center justify-between w-[100%]">
                      <Row className="items-center w-[56%]">
                  ...
                  >
                    <Row className="items-center justify-evenly lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] w-[100%]">
                      <Row className="justify-between w-[78%]">
                        <Img
                          src="images/img_unsplashohkelo_4.png"
                    ...
                    <Row className="items-center justify-evenly lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] w-[100%]">
                      <Row className="justify-between w-[78%]">
                        <Img
                          src="images/img_unsplashzmmanl_3.png"
                          className="lg:h-[28px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] rounded-radius50 lg:w-[28px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]"
                          alt="unsplashZmmAnl"
                        />
                        <Column className="w-[72%]">
                    ...
                    <Row className="items-center justify-evenly lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] w-[100%]">
                      <Row className="justify-between w-[78%]">
                        <Img
                          src="images/img_unsplashttsrji_3.png"
                          className="lg:h-[28px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] rounded-radius50 lg:w-[28px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px]"
                          alt="unsplashttSRji"
                        />
                        <Column className="w-[72%]">
